...
function FeaturesSection() {
    const features = [
        ...
        { icon: RefreshCcw, color: "text-emerald-400", title: "Software Updates", badge: "winget", desc: "Scan installed apps with available updates, choose packages one by one, keep stable by default, switch to known beta channels, and schedule an automatic update script." },
        ...
        { icon: RefreshCcw, color: "text-cyan-400", title: "Automation Center", badge: "Scheduler", desc: "Schedule recurring maintenance scripts for cleanup, Defender, inventories, network diagnostics, system reports, and health snapshots." },
