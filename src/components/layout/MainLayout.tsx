...
export function MainLayout({
    ...
    return (
        <div className="h-screen overflow-x-auto bg-background">
        <div className="flex h-screen app-wrapper overflow-hidden bg-background text-foreground transition-colors duration-300 min-w-[480px]">
