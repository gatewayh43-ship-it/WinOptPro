...
export function ConsentModal({ onAccept, onDecline }: ConsentModalProps) {
  return (
    <div data-testid="consent-modal" className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-background border border-border rounded-2xl shadow-2xl w-full max-w-md mx-4 flex flex-col">
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h2 className="text-xl font-bold text-foreground">Welcome to WinOpt Pro</h2>
          </div>
