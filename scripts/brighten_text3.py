...
for root, dirs, files in os.walk(src_dir):
    for file in files:
        if file.endswith(".tsx") or file.endswith(".ts"):
            ...
            # Brighten pre-existing dark text colors that didn't get caught by the first script
            ...
            new_content = new_content.replace("dark:text-slate-600", "dark:text-slate-400")
